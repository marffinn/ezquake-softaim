...
cvar_t cl_softaim = { "cl_softaim", "0" };
cvar_t cl_softaim_strength = { "cl_softaim_strength", "1.0" };
cvar_t cl_softaim_maxdist = { "cl_softaim_maxdist", "512" };
cvar_t cl_softaim_fov = { "cl_softaim_fov", "90" };
cvar_t cl_softaim_smooth = { "cl_softaim_smooth", "0.3" };
cvar_t cl_softaim_autoswitch = { "cl_softaim_autoswitch", "0" };
cvar_t cl_softaim_lg_range = { "cl_softaim_lg_range", "350" };
...
static qbool CL_SoftAim_FindBestTarget(vec3_t target_origin, float *target_distance)
{
	...
	float max_fov = cl_softaim_fov.value * 0.5f;
	static double last_debug_time = 0;
	int active_players = 0, valid_enemies = 0;
...
void CL_InitInput(void)
{
	...
	// Soft-aim cvars
	Cvar_Register(&cl_softaim);
	Cvar_Register(&cl_softaim_strength);
	Cvar_Register(&cl_softaim_maxdist);
	Cvar_Register(&cl_softaim_fov);
	Cvar_Register(&cl_softaim_smooth);
	Cvar_Register(&cl_softaim_autoswitch);
	Cvar_Register(&cl_softaim_lg_range);
